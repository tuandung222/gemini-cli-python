...
| `packages/core/src/scheduler/scheduler.ts` | `src/py_agent_runtime/scheduler/scheduler.py` | in_progress | Pipeline baseline implemented; confirmation loop pending | SCH-001 |
...
| `packages/core/src/scheduler/confirmation.ts` | `src/py_agent_runtime/scheduler/confirmation.py` | planned | Correlated confirmation loop not yet implemented | SCH-003 |
...
| `packages/core/src/agents/local-executor.ts` | `src/py_agent_runtime/agents/local_executor.py` | in_progress | `complete_task` terminal contract baseline implemented | AGT-001 |
| `packages/core/src/agents/registry.ts` | `src/py_agent_runtime/agents/registry.py` | planned | Dynamic subagent policy pending | AGT-002 |
| `packages/core/src/confirmation-bus/message-bus.ts` | `src/py_agent_runtime/bus/message_bus.py` | in_progress | Basic pub/sub done; policy-aware request/response pending | BUS-001 |
...
| AGT-001 | `tests/test_local_executor.py` | `complete_task` protocol baseline |
